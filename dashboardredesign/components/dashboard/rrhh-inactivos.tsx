    ...
    empleados: [
      {
        id: 1,
        nombre: "Celeste Gil",
        email: "gilcantarutti704@gmail.com",
        fEntrevista: "-",
        fIngreso: "12/11/2025",
        cargo: "asesor",
        telefono: "-",
    ...
    empleados: [
      {
        id: 3,
        nombre: "Luka Menguez",
        email: "menguezluka2024@gmail.com",
        fEntrevista: "-",
        fIngreso: "27/10/2025",
        cargo: "asesor",
        telefono: "-",
    ...
    empleados: [
      {
        id: 4,
        nombre: "Nahiara Diaz",
        email: "nahiaraanabella0805@gmail.com",
        fEntrevista: "-",
        fIngreso: "17/11/2025",
        cargo: "asesor",
        telefono: "-",
      ...
      {
        id: 5,
        nombre: "Abril Centurion",
        email: "abrilcenturion40@gmail.com",
        fEntrevista: "-",
        fIngreso: "4/7/2025",
        cargo: "asesor",
        telefono: "1171330038",
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          >
            ...
            <option value="222">Equipo 222</option>

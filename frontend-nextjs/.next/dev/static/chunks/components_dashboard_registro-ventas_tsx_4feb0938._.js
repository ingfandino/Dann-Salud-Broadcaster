...
"[project]/components/dashboard/registro-ventas.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$registro$2d$ventas$2d$edit$2d$modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/dashboard/registro-ventas-edit-modal.tsx [app-client] (ecmascript)");
...
const getAuditDateKey = (audit)=>{
    ...
    if (Number.isNaN(d.getTime())) return dateValue.split('T')[0] || "";
    const ar = new Date(d.toLocaleString("en-US", {
...
const STATUS_COLORS = {
    "qr hecho": {
        ...
        row: {
            ...
            dark: "bg-green-900/20 hover:bg-green-900/30"
        }
    },
    "aprobada": {
        badge: {
        ...
        row: {
            ...
            dark: "bg-teal-900/20 hover:bg-teal-900/30"
        }
    },
    "pendiente": {
        badge: {
            light: "bg-stone-100 text-stone-600",
            dark: "bg-stone-500/30 text-stone-300"
        },
        row: {
            light: "bg-stone-50 hover:bg-stone-100",
            dark: "bg-stone-800/20 hover:bg-stone-800/30"
        }
    },
    "cargada": {
        badge: {
    ...
    "padrón": {
        badge: {
            ...
            dark: "bg-amber-500/30 text-amber-300"
        },
        row: {
            light: "bg-amber-50 hover:bg-amber-100",
            dark: "bg-amber-900/20 hover:bg-amber-900/30"
        }
    },
    "remuneración no válida": {
        badge: {
            light: "bg-red-200 text-red-800",
            dark: "bg-red-700/30 text-red-400"
        },
        row: {
    ...
    "caída": {
        badge: {
            ...
            dark: "bg-rose-800/40 text-rose-300"
        },
        row: {
            light: "bg-rose-100 hover:bg-rose-200",
            dark: "bg-rose-900/30 hover:bg-rose-900/40"
        }
    },
    "en revisión": {
        badge: {
            light: "bg-slate-100 text-slate-600",
            dark: "bg-slate-500/30 text-slate-300"
        },
        row: {
            light: "bg-slate-50 hover:bg-slate-100",
            dark: "bg-slate-800/20 hover:bg-slate-800/30"
        }
    },
    "afip": {
        badge: {
        ...
        row: {
            ...
            dark: "bg-slate-700/30 hover:bg-slate-700/40"
        }
    },
    "hacer qr": {
        badge: {
            light: "bg-yellow-100 text-yellow-700",
            dark: "bg-yellow-500/30 text-yellow-300"
        },
        row: {
    ...
    "qr hecho (temporal)": {
        ...
        row: {
            light: "bg-lime-50 hover:bg-lime-100",
            dark: "bg-lime-900/20 hover:bg-lime-900/30"
        }
    },
    "qr hecho pero pendiente de aprobación": {
        badge: {
        ...
        row: {
            light: "bg-emerald-50 hover:bg-emerald-100",
            dark: "bg-emerald-900/20 hover:bg-emerald-900/30"
        }
    },
    "baja laboral con nueva alta": {
        badge: {
    ...
    "baja laboral sin nueva alta": {
        ...
        row: {
            light: "bg-slate-50 hover:bg-slate-100",
            dark: "bg-slate-900/20 hover:bg-slate-900/30"
        }
    },
    "aprobada, pero no reconoce clave": {
        badge: {
...
const getAporteColor = (aporte, theme)=>{
...
const getObraSocialVendidaColor = (obra, theme)=>{
...
const copyColumnToClipboard = async (audits, columnKey, fieldName, toastFn)=>{
    try {
        ...
        toastFn.success(`${values.length} ${fieldName} copiados`, {
            duration: 1500
        });
    } catch (err) {
...
function RegistroVentas() {
    ...
    const [dateFrom, setDateFrom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(weeklyPeriod.dateFrom);
    const [dateTo, setDateTo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(weeklyPeriod.dateTo);
    ...
    const [asesoresList, setAsesoresList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [selectedAudit, setSelectedAudit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [bulkUploadOpen, setBulkUploadOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const filteredAsesoresList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegistroVentas.useMemo[filteredAsesoresList]": ()=>{
            if (selectedSupervisores.length === 0) return asesoresList;
            const equiposSupervisores = new Set();
            selectedSupervisores.forEach({
                "RegistroVentas.useMemo[filteredAsesoresList]": (supName)=>{
                    const sup = supervisoresList.find({
                        "RegistroVentas.useMemo[filteredAsesoresList].sup": (s)=>s.nombre === supName
                    }["RegistroVentas.useMemo[filteredAsesoresList].sup"]);
            ...
            return asesoresList.filter({
                "RegistroVentas.useMemo[filteredAsesoresList]": (a)=>a.numeroEquipo && equiposSupervisores.has(a.numeroEquipo)
            }["RegistroVentas.useMemo[filteredAsesoresList]"]);
        }
    }["RegistroVentas.useMemo[filteredAsesoresList]"], [
        asesoresList,
    ...
    const isQRHechoFilterActive = selectedEstados.some((e)=>e.toLowerCase() === "qr hecho");
    const visibleAudits = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegistroVentas.useMemo[visibleAudits]": ()=>{
            if (isQRHechoFilterActive) return audits;
            return audits.filter({
                "RegistroVentas.useMemo[visibleAudits]": (audit)=>{
    ...
    const fetchAudits = async ()=>{
        try {
            ...
            const filteredAudits = auditsArray.filter((audit)=>{
                const statusLower = (audit.status || "").toLowerCase().trim();
                // ✅ Incluir registros con estado "QR hecho" o variantes (igual que Liquidación)
                if (statusLower === "qr hecho" || statusLower === "qr hecho (temporal)" || statusLower === "qr hecho pero pendiente de aprobación" || statusLower === "cargada" || statusLower === "aprobada") {
                    return true;
                }
                ...
                if (audit.statusHistory && Array.isArray(audit.statusHistory)) {
                    return audit.statusHistory.some((h)=>estadosIncluidos.includes((h.value || "").toLowerCase()));
                }
                return false;
            });
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error al cargar registros de ventas");
            setAudits([]);
        } finally{
            setLoading(false);
        }
    ...
    const fetchFilterOptions = async ()=>{
        try {
            ...
            const asesoresFiltered = asesoresData.filter((u)=>{
                ...
                const isAsesor = u.role === "asesor" || u.role === "Asesor" || u.role === "independiente" || u.role === "Independiente";
            ...
            const supervisoresData = asesoresData.filter((u)=>{
                const isActive = u?.active !== false;
                return isActive && (u.role === "supervisor" || u.role === "Supervisor" || u.role === "encargado" || u.role === "Encargado" || u._id === "68f2688f549813490d3ee8ee") && u.nombre;
            }).sort((a, b)=>a.nombre.localeCompare(b.nombre));
            setSupervisoresList(supervisoresData);
            const administradoresData = asesoresData.filter((u)=>{
                const isActive = u?.active !== false;
    ...
    const handleExportXLSX = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(wb, ws, "Registro de Ventas");
    ...
    const handleDeleteAudit = async (auditId)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Registro eliminado");
            fetchAudits();
        } catch (error) {
            console.error("Error deleting audit:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error al eliminar registro");
        }
    };
    const openEditModal = (audit)=>{
        ...
        if (audit.enProceso?.activo && audit.enProceso.procesadoPor?._id !== user?._id) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Esta venta está siendo procesada por ${procesador}. No puede editarla en este momento.`, {
                duration: 4000
            });
            return;
        }
    ...
    const handleToggleEnProceso = async (audit)=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].audits.toggleEnProceso(audit._id);
            // Actualizar el estado local
            setAudits((prev)=>prev.map((a)=>a._id === audit._id ? data.audit : a));
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.message || 'Error al actualizar estado');
        }
    };
    ...
    const processBulkUpload = async ()=>{
        ...
        try {
            ...
            if (jsonData.length === 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('El archivo está vacío');
                setUploadProgress((prev)=>({
                        ...prev,
                        status: 'error'
                    }));
            ...
            const columnMapping = {
                ...
                'osanterior': 'obraSocialAnterior',
                'obra social vendida': 'obraSocialVendida',
                'os vendida': 'obraSocialVendida',
                'osvendida': 'obraSocialVendida',
                'obra social': 'obraSocialVendida',
                ...
                'observación': 'observacionPrivada',
                'obs': 'observacionPrivada',
                'observacion privada': 'observacionPrivada',
                'clave': 'clave',
                'email': 'email',
                'correo': 'email',
            ...
            const normalizedRecords = jsonData.map((row)=>{
                const normalized = {};
            ...
            for (const batch of batches){
                try {
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].audits.bulkImport({
                        records: batch
                    });
            ...
            if (totalSuccess > 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${totalSuccess} registros importados correctamente`);
                fetchAudits();
            }
            if (totalErrors > 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning(`${totalErrors} registros con errores`);
            }
        } catch (err) {
            console.error('Error processing file:', err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Error al procesar el archivo: ' + err.message);
            setUploadProgress((prev)=>({
                    ...prev,
                    status: 'error'
                }));
    ...
    const downloadRejectedRecords = ()=>{
        ...
        const ws = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(rows);
        const wb = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_new();
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(wb, ws, 'Rechazados');
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeFile"](wb, `registros_rechazados_${new Date().toISOString().slice(0, 10)}.xlsx`);
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RegistroVentas.useEffect": ()=>{
            ...
            const handleAuditUpdate = {
                "RegistroVentas.useEffect.handleAuditUpdate": (updatedAudit)=>{
                    setAudits({
                        "RegistroVentas.useEffect.handleAuditUpdate": (prev)=>{
                            const index = prev.findIndex({
                                "RegistroVentas.useEffect.handleAuditUpdate.index": (a)=>a._id === updatedAudit._id
                            }["RegistroVentas.useEffect.handleAuditUpdate.index"]);
                            if (index === -1) {
                    ...
                    }["RegistroVentas.useEffect.handleAuditUpdate"]);
                    setSelectedAudit({
                        "RegistroVentas.useEffect.handleAuditUpdate": (prev)=>{
            ...
            const handleAuditDeleted = {
                "RegistroVentas.useEffect.handleAuditDeleted": (data)=>{
                    setAudits({
                        "RegistroVentas.useEffect.handleAuditDeleted": (prev)=>prev.filter({
                                "RegistroVentas.useEffect.handleAuditDeleted": (a)=>a._id !== data._id
                            }["RegistroVentas.useEffect.handleAuditDeleted"])
                    }["RegistroVentas.useEffect.handleAuditDeleted"]);
                    if (selectedAudit && selectedAudit._id === data._id) {
                        setEditModalOpen(false);
                        setSelectedAudit(null);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("El registro ha sido eliminado");
                    }
                }
            }["RegistroVentas.useEffect.handleAuditDeleted"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RegistroVentas.useEffect": ()=>{
            const handleClickOutside = {
                "RegistroVentas.useEffect.handleClickOutside": (event)=>{
                    if (estadoFilterRef.current && !estadoFilterRef.current.contains(event.target)) {
                    ...
                    if (administradorFilterRef.current && !administradorFilterRef.current.contains(event.target)) {
                        setIsAdministradorDropdownOpen(false);
                    }
                }
            }["RegistroVentas.useEffect.handleClickOutside"];
            document.addEventListener("mousedown", handleClickOutside);
            return ({
                "RegistroVentas.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["RegistroVentas.useEffect"];
        }
    }["RegistroVentas.useEffect"], []);
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$filter$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Filter$3e$__["Filter"], {
                                ...
                                fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                lineNumber: 1063,
                                columnNumber: 11
                            }, this),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 mb-3",
                        children: [
                                ...
                                children: [
                                    ...
                                    isEstadoDropdownOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            STATUS_OPTIONS.map((estado)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                ...
                                children: [
                                    ...
                                    isSupervisorDropdownOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            supervisoresList.map((sup)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "flex items-center gap-2 px-3 py-2 text-xs hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            type: "checkbox",
                                ...
                                children: [
                                    ...
                                    isAsesorDropdownOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            filteredAsesoresList.map((asesor)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "flex items-center gap-2 px-3 py-2 text-xs hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            type: "checkbox",
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "truncate",
                                                children: formatMultiLabel(selectedAdministradores, "Administrativo", "admins")
                                            }, void 0, false, {
                                                fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                lineNumber: 1239,
                                                columnNumber: 15
                                    ...
                                    isAdministradorDropdownOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            administradoresList.map((admin)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "flex items-center gap-2 px-3 py-2 text-xs hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            type: "checkbox",
            ...
            visibleAudits.length > 0 && (()=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-xl border p-3 mb-4", theme === "dark" ? "bg-gradient-to-r from-purple-900/20 to-fuchsia-900/20 border-purple-700/30" : "bg-gradient-to-r from-purple-50 to-fuchsia-50 border-purple-200"),
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-wrap items-center gap-2 text-sm",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-bold", theme === "dark" ? "text-gray-200" : "text-gray-800"),
                                children: "Por Administrativo:"
                            }, void 0, false, {
                                fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                lineNumber: 1389,
                                columnNumber: 15
                            }, this),
                            adminOrdenados.map(([admin, count])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: theme === "dark" ? "text-gray-300" : "text-gray-700",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "font-semibold",
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center min-w-[150px]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>copyColumnToClipboard(visibleAudits, "nombre", "Afiliados", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]),
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$copy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Copy$3e$__["Copy"], {
                                                        className: "w-3 h-3 opacity-0 group-hover/hdr:opacity-70 transition-opacity"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1426,
                                                        columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center w-[100px]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>copyColumnToClipboard(visibleAudits, "cuil", "CUILs", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]),
                                                className: "inline-flex items-center gap-1 hover:text-blue-500 dark:hover:text-blue-400 transition-colors group/hdr",
                                                title: "Copiar toda la columna",
                                                children: [
                                                    "CUIL",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center w-[100px]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>copyColumnToClipboard(visibleAudits, "telefono", "Teléfonos", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]),
                                                className: "inline-flex items-center gap-1 hover:text-blue-500 dark:hover:text-blue-400 transition-colors group/hdr",
                                                title: "Copiar toda la columna",
                                                children: [
                                                    "Teléfono",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center min-w-[100px]",
                                            children: "Supervisor"
                                        }, void 0, false, {
                                            fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                            lineNumber: 1450,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center w-[80px]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>copyColumnToClipboard(visibleAudits, "aporte", "Aportes", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]),
                                                className: "inline-flex items-center gap-1 hover:text-blue-500 dark:hover:text-blue-400 transition-colors group/hdr",
                                                title: "Copiar toda la columna",
                                                children: [
                                                    "Aporte",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center w-[100px]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>copyColumnToClipboard(visibleAudits, "cuit", "CUITs", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]),
                                                className: "inline-flex items-center gap-1 hover:text-blue-500 dark:hover:text-blue-400 transition-colors group/hdr",
                                                title: "Copiar toda la columna",
                                                children: [
                                                    "CUIT",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-2 py-2 text-center w-[100px]",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>copyColumnToClipboard(visibleAudits, "email", "Emails", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"]),
                                                className: "inline-flex items-center gap-1 hover:text-blue-500 dark:hover:text-blue-400 transition-colors group/hdr",
                                                title: "Copiar toda la columna",
                                                children: [
                                                    "Email",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                ...
                                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    lineNumber: 1492,
                                    columnNumber: 17
                                }, this) : visibleAudits.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                        colSpan: 16,
                                        className: "px-4 py-8 text-center opacity-50",
                                        children: audits.length > 0 && !isQRHechoFilterActive ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    children: 'Todos los registros están en estado "QR hecho"'
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1506,
                                                    columnNumber: 25
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-xs",
                                                    children: "Filtra por estado para verlos"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1507,
                                                    columnNumber: 25
                                            ...
                                            lineNumber: 1504,
                                            columnNumber: 23
                                        }, this) : "No se encontraron registros"
                                    }, void 0, false, {
                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                        lineNumber: 1502,
                                        columnNumber: 19
                                    ...
                                    lineNumber: 1501,
                                    columnNumber: 17
                                }, this) : visibleAudits.map((audit, idx)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            showDaySeparator && currentDateKey && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "sticky top-[41px] z-[5]",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    colSpan: 16,
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-0 py-0", theme === "dark" ? "bg-gray-900" : "bg-white"),
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative px-4 py-3 font-bold text-sm overflow-hidden", "border-y-2 shadow-md", theme === "dark" ? "bg-gradient-to-r from-indigo-900/80 via-purple-900/60 to-indigo-900/80 text-white border-indigo-400/50" : "bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 text-white border-indigo-300"),
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "absolute inset-0 bg-[linear-gradient(90deg,transparent_0%,rgba(255,255,255,0.1)_50%,transparent_100%)] animate-shimmer"
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                                lineNumber: 1541,
                                                                columnNumber: 31
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-1.5 rounded-lg", theme === "dark" ? "bg-white/20" : "bg-white/30"),
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        ...
                                                                        children: formatDayHeader(currentDateKey)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                                        lineNumber: 1549,
                                                                        columnNumber: 33
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-xs px-2 py-1 rounded-full", theme === "dark" ? "bg-white/20" : "bg-white/30"),
                                                                        children: [
                                                                            visibleAudits.filter((a)=>getAuditDateKey(a) === currentDateKey).length,
                                                                            " registros"
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                            ...
                                            }, `day-${currentDateKey}-${idx}`, false, {
                                                fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                lineNumber: 1524,
                                                columnNumber: 25
                                            }, this),
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("transition-colors group relative", // Animación de pulso para ventas en proceso
                                                audit.enProceso?.activo && "animate-pulse-slow", // Fondo destacado para ventas en proceso
                                                audit.enProceso?.activo ? theme === "dark" ? "bg-gradient-to-r from-orange-900/40 via-orange-800/30 to-orange-900/40 hover:from-orange-900/50 hover:via-orange-800/40 hover:to-orange-900/50 border-l-4 border-orange-500" : "bg-gradient-to-r from-orange-100 via-orange-50 to-orange-100 hover:from-orange-200 hover:via-orange-100 hover:to-orange-200 border-l-4 border-orange-500" : getRowBackgroundByStatus(audit.statusAdministrativo || audit.status, theme) || (idx % 2 === 0 ? "" : theme === "dark" ? "bg-white/[0.02]" : "bg-gray-50/50")),
                                                title: audit.enProceso?.activo && audit.enProceso.procesadoPor?._id !== user?._id ? `⚠️ En proceso por: ${audit.enProceso.procesadoPor?.nombre || 'Otro usuario'}\n📋 Afiliado: ${audit.nombre}\n📞 CUIL: ${audit.cuil || 'N/A'}\n\n🔒 No puede editar esta venta mientras esté siendo procesada.` : undefined,
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-2 py-2 text-center", theme === "dark" ? "text-gray-400" : "text-gray-500"),
                                                        children: audit.fechaCreacionQR ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex flex-col items-center",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-purple-500 font-medium",
                                                                    children: formatDateOnly(audit.fechaCreacionQR)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                                    lineNumber: 1584,
                                                                    columnNumber: 31
                                                            ...
                                                            lineNumber: 1583,
                                                            columnNumber: 29
                                                        }, this) : formatDateTime(audit.scheduledAt)
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1581,
                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2 text-center font-medium truncate max-w-[150px]",
                                                        title: audit.nombre,
                                                        children: audit.nombre ? audit.nombre.toUpperCase() : "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1595,
                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-2 py-2 text-center font-mono truncate", theme === "dark" ? "text-gray-400" : "text-gray-500"),
                                                        children: audit.cuil || "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1598,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex px-1.5 py-0.5 rounded text-[10px] font-medium truncate max-w-[80px]", getObraSocialVendidaColor(audit.obraSocialVendida, theme)),
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2 text-center",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-2 py-0.5 rounded text-[10px] font-medium truncate max-w-[120px] inline-block", getSupervisorColor(getSupervisorName(audit), theme)),
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-2 py-2 text-center", theme === "dark" ? "text-gray-300" : "text-gray-700"),
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2 text-center",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex px-1.5 py-0.5 rounded text-[10px] font-medium truncate max-w-[120px]", getStatusColor(audit.statusAdministrativo || audit.status, theme)),
                                                            title: audit.statusAdministrativo || audit.status,
                                                            children: audit.statusAdministrativo || audit.status || "-"
                                                        }, void 0, false, {
                                                            fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                            lineNumber: 1624,
                                                            columnNumber: 27
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-2 py-2 text-center font-semibold", getAporteColor(audit.aporte, theme)),
                                                        children: audit.aporte ? `$${audit.aporte.toLocaleString()}` : "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1631,
                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2 text-center max-w-[100px] truncate",
                                                        title: audit.datosExtra,
                                                        children: audit.datosExtra ? audit.datosExtra.charAt(0).toUpperCase() + audit.datosExtra.slice(1).toLowerCase() : "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1637,
                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2 text-center max-w-[100px] truncate",
                                                        title: audit.observacionPrivada,
                                                        children: audit.observacionPrivada ? audit.observacionPrivada.charAt(0).toUpperCase() + audit.observacionPrivada.slice(1).toLowerCase() : "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1640,
                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-2 py-2 text-center", theme === "dark" ? "text-gray-400" : "text-gray-600"),
                                                        children: audit.administrador?.nombre || "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                        lineNumber: 1649,
                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                audit.administrador?._id === user?._id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: ()=>handleToggleEnProceso(audit),
                                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-1 rounded transition-colors", audit.enProceso?.activo ? "bg-orange-100 text-orange-600 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400 dark:hover:bg-orange-900/50" : "hover:bg-gray-100 text-gray-600 dark:hover:bg-gray-800 dark:text-gray-400"),
                                                                    title: audit.enProceso?.activo ? "Marcar como disponible" : "Marcar como en proceso",
                                                                    children: audit.enProceso?.activo ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$pause$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Pause$3e$__["Pause"], {
                                                                        className: "w-3 h-3"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                                        lineNumber: 1667,
            ...
            selectedAudit && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$registro$2d$ventas$2d$edit$2d$modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RegistroVentasEditModal"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fixed top-0 right-0 h-full z-40 transition-transform duration-300 ease-out", "w-full sm:w-[420px] max-w-[90vw]", bulkUploadOpen ? "translate-x-0" : "translate-x-full"),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-full overflow-y-auto shadow-2xl border-l", theme === "dark" ? "bg-gray-900 border-white/10" : "bg-white border-gray-200"),
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "sticky top-0 z-10 px-4 py-3 border-b flex items-center justify-between",
                            style: {
                                background: theme === "dark" ? "rgb(17, 24, 39)" : "white"
                            },
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-base font-bold flex items-center gap-2", theme === "dark" ? "text-white" : "text-gray-800"),
                                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-1.5 rounded-lg transition-colors", theme === "dark" ? "hover:bg-white/10 text-gray-400" : "hover:bg-gray-100 text-gray-500"),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-lg border-2 border-dashed p-4 text-center transition-colors", theme === "dark" ? "border-white/20 hover:border-purple-500/50 bg-white/5" : "border-gray-300 hover:border-purple-400 bg-gray-50"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            type: "file",
                                            accept: ".xlsx,.xls",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$upload$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Upload$3e$__["Upload"], {
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-8 h-8 mx-auto mb-2", theme === "dark" ? "text-gray-500" : "text-gray-400")
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1765,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: uploadFile ? uploadFile.name : "Seleccionar archivo Excel"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1766,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-xs mt-1", theme === "dark" ? "text-gray-500" : "text-gray-500"),
                                                    children: ".xlsx o .xls (hasta 100k registros)"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1769,
                                                    columnNumber: 17
                                ...
                                uploadFile && uploadProgress.status === 'idle' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                uploadProgress.status === 'processing' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-lg p-3", theme === "dark" ? "bg-white/5" : "bg-gray-100"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center justify-between mb-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-xs font-medium", theme === "dark" ? "text-white" : "text-gray-700"),
                                                    children: "Procesando..."
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1788,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "w-full h-1.5 rounded-full bg-gray-300 dark:bg-gray-700 overflow-hidden",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                uploadProgress.errors > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                uploadProgress.status === 'complete' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-lg p-3", theme === "dark" ? "bg-green-900/20 border border-green-500/30" : "bg-green-50 border border-green-200"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-medium text-sm", theme === "dark" ? "text-green-300" : "text-green-700"),
                                                    children: "Completado"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1814,
                                        ...
                                        uploadProgress.rejectedRecords.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: [
                                                ...
                                                uploadProgress.rejectedRecords.length,
                                                ")"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                ...
                                uploadProgress.status === 'error' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-lg p-3 border", theme === "dark" ? "bg-red-900/20 border-red-500/30" : "bg-red-50 border-red-200"),
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("details", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-lg border overflow-hidden", theme === "dark" ? "bg-white/5 border-white/10" : "bg-blue-50/50 border-blue-200"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("summary", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-3 py-2 cursor-pointer text-sm font-medium flex items-center gap-2 select-none", theme === "dark" ? "text-blue-300 hover:bg-white/5" : "text-blue-700 hover:bg-blue-100/50"),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$info$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Info$3e$__["Info"], {
                                                    className: "w-4 h-4"
                                                }, void 0, false, {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "px-1 py-0.5 rounded bg-red-500/20 text-red-400 text-[10px]",
                                                            children: "*"
                                                        }, void 0, false, {
                                                            fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                            lineNumber: 1860,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("pt-1 text-[11px]", theme === "dark" ? "text-gray-500" : "text-gray-500"),
                                                    children: "Opcionales: cuil, supervisor, asesor, administrativo, estado, aporte, cuit, clave, email"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/dashboard/registro-ventas.tsx",
                                                    lineNumber: 1871,
                                                    columnNumber: 17
...
_s(RegistroVentas, "3ouZ2pvMJXTluk3TywU5FzBtqLM=", false, function() {
    return [
...
_c = RegistroVentas;
var _c;
__turbopack_context__.k.register(_c, "RegistroVentas");
...
//# sourceMappingURL=components_dashboard_registro-ventas_tsx_4feb0938._.js.map
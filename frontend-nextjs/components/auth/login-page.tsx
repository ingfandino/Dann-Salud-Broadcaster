...
export function LoginPage({ onLogin, onRegister, onRecover }: LoginPageProps) {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full px-4 py-3 pr-12 rounded-xl transition-all duration-300 focus:ring-2 focus:ring-[#1E88E5] focus:outline-none ${
                      theme === "dark"
                        ? "bg-white/10 border border-white/20 text-white placeholder-gray-500"
                        : "bg-white border border-gray-200 text-gray-900 placeholder-gray-400"
                    }`}

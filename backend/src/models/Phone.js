...
const phoneSchema = new mongoose.Schema({
    /** Supervisor responsable del teléfono (null si esAsesorIndependiente) */
    supervisor: {
        type: mongoose.Schema.Types.ObjectId,
        ref: 'User',
        default: null
    ...
    /** Indica si el teléfono está asignado a un asesor independiente (sin supervisor) */
    esAsesorIndependiente: {
        type: Boolean,
        default: false
    },
    /** Indica si el teléfono es de uso propio del usuario que lo registra */
    usoPropio: {
        type: Boolean,
        default: false
    },

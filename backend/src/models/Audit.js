...
const AuditSchema = new Schema({
    ...
    ultima_revision: { type: Date, default: null },

    /** Usuario que realizó la última revisión */
    revisado_por: { type: Schema.Types.ObjectId, ref: 'User', default: null },

    /** Indica si el registro está listo para reventa */
    lista_para_reventa: { type: Boolean, default: false },
 ...
 * (permite asignar supervisores con rol Gerencia como Eliana Soledad)
 */

...
// Obtener usuarios independientes (para dropdown cuando esAsesorIndependiente está activo)
router.get('/independientes', isGerencia, phoneController.getIndependientes);

// Obtener todos los asesores e independientes (para filtro de búsqueda)
router.get('/asesores-filter', isGerenciaOrSupervisor, phoneController.getAllAsesoresForFilter);

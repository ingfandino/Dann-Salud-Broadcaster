...
router.put('/:id', canEdit, employeeController.updateEmployee); // Editar campos generales (NO toca activo/fechaBaja/fechaEgreso)
router.put('/:id/deactivate', canEdit, employeeController.deactivateEmployee); // Dar de baja (requiere motivoBaja + fechaEgreso)
router.put('/:id/reactivate', canEdit, employeeController.reactivateEmployee); // Reactivar empleado
